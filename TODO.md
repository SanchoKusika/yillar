...
- [x] Web Share API + clipboard fallback реализованы (`src/shared/lib/share.ts`)
- [ ] Полноценная share-карточка: canvas/html2canvas с результатами в виде изображения — вот это расшаривается (см. Wordle, Spotify Wrapped). Текстовый share малоценен.
